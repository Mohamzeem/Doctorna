...
class _$FailureImpl<T> implements Failure<T> {
  const _$FailureImpl({required this.errMsg});
  ...
  @override
  String toString() {
    return 'RegisterState<$T>.failure(errMsg: $errMsg)';
  }
...
abstract class Failure<T> implements RegisterState<T> {
  const factory Failure({required final String errMsg}) = _$FailureImpl<T>;
